package com.vanravi.fancygallery.ext
...
import com.vanravi.fancygallery.FancyGalleryApp
import com.vanravi.fancygallery.utils.Constants
import java.io.File
...
fun Bitmap.saveToInternalStorage(name: String): Uri? {
    val context = FancyGalleryApp.applicationContext()
