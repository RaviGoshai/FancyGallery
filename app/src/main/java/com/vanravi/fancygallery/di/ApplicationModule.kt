package com.vanravi.fancygallery.di
...
import com.vanravi.fancygallery.utils.Constants.Companion.BASE_URL
import com.vanravi.fancygallery.utils.Constants.Companion.TAG
...
object ApplicationModule {
    ...
    @Provides
    @Singleton
    fun providePicsumApi(retrofit: Retrofit): FancyGalleryApi = retrofit.create(FancyGalleryApi::class.java)
